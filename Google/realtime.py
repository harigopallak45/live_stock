...
def init():
    ...
    ax.set_ylim(160, 170)  # Adjust this based on the actual range of stock prices
...
close = [161 + i * 0.01 for i in range(200)]  # Example range close to real stock price
volume = [600000 + i * 1000 for i in range(200)]  # Example volume data
